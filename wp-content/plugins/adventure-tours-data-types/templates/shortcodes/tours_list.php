		...
		<div class="at-atlist__item__content">
			<div class="at-atlist__item__content__items">
				<div class="at-atlist__item__content__item">
					<h2 class="at-atlist__item__title"><a href="<?php echo esc_url( $permalink ); ?>"><?php echo $item->post->post_title ?></a></h2>
					<div class="at-atlist__item__description"><?php echo esc_html( $item->post->post_content ); ?></div>
				</div>
