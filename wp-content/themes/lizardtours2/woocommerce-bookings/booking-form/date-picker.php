...
<fieldset class="wc-bookings-date-picker wc-bookings-date-picker-<?php echo esc_attr( $product_type ); ?> <?php echo implode( ' ', $class ); ?>">
	<legend>
		<span class="label"><?php echo $label; ?></span>: <small class="wc-bookings-date-picker-choose-date"><?php _e( 'Calendar...', 'woocommerce-bookings' ); ?></small>
	</legend>
	...
	<div class="wc-bookings-date-picker-date-fields">
		...
		<label class="wc-bookings-date-picker-choose-date">
